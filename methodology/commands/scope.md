...
- A recommendation line, one of: **reject | defer | merge | one-off | create**,
  with one paragraph of reasoning. If `merge`, name the target workflow. If
  `create`, include the proposed `workflow_id`.

# Workflow: {{WORKFLOW_NAME}} — working rules
...
## Promotion
- This workflow cannot reach `production` until evals pass and the requester has
  accepted a sample (recorded in `logs/decisions.md`). See
